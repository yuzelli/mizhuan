package com.mizhuan.app.mizhuan.utils;
...
import com.mizhuan.app.mizhuan.MizhuanApplication;
...
public class MyToast extends Toast{
    ...
    public static void show(String content) {
        ...
        mToast =  MyToast.makeText(MizhuanApplication.getContext(), 0, content, 100);
        mToast.show();
    }
    public static void show(String content,int drawableID) {

        mToast =  MyToast.makeText(MizhuanApplication.getContext(),drawableID, content, 100);
        mToast.show();
    }
